...
public class File1Client {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //System.out.println("clientPrivateKey:" + clientPrivateKey + "clientPublicKey: " + clientPublicKey);
       ...
       testKey data = new testKey("Msc", "Cyber Security", 5);
        ...
        byte[] datatBytes = byteArrayOutputStream.toByteArray();
        byte[] encrypteddata = cipher.doFinal(datatBytes);
