...
public class File2ServerSkel {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //System.out.println("serverPrivateKey:" + serverPrivateKey + "serverPublicKey: " + serverPublicKey);
        ...
        testKey data = (testKey) objectInputStream.readObject();
